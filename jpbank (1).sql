...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13-Jun-2025 às 13:45
...
CREATE TABLE `admnistrativo` (
  `documentoResponsavel` varchar(45) NOT NULL,
  `emailComercial` text NOT NULL,
  `investimentoPorSetor` float DEFAULT NULL,
  `numeroProfissionais` int(11) DEFAULT NULL,
  `numeroDeContatoVitalicio` bigint(11) DEFAULT NULL,
  `numeroDeClientesCadastradosMes` int(11) DEFAULT NULL,
  `numeroDeProfissionaisRecrutadosMes` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Extraindo dados da tabela `admnistrativo`
--

INSERT INTO `admnistrativo` (`documentoResponsavel`, `emailComercial`, `investimentoPorSetor`, `numeroProfissionais`, `numeroDeContatoVitalicio`, `numeroDeClientesCadastradosMes`, `numeroDeProfissionaisRecrutadosMes`) VALUES
('Francisco Maravilha', 'comercial6@gmail.com', 1.006, 15, 49911111116, 6, 2),
('Marcilha Silverira', 'comercial3@gmail.com', 1.003, 12, 49911111113, 3, 5),
('Mauri Campos', 'comercial4@gmail.com', 1.004, 13, 49911111114, 4, 4),
('Robert Santos', 'comercial2@gmail.com', 1.002, 11, 49911111112, 2, 6),
('Roger Silva', 'comercial1@gmail.com', 1.001, 10, 49911111111, 1, 7),
('Tiago Costa', 'comercial5@gmail.com', 1.005, 14, 49911111115, 5, 3),
('Tiago Silveira', 'comercial7@gmail.com', 1.007, 16, 49911111117, 7, 1);
...
CREATE TABLE `agencias` (
  ...
  `nomeAgencia` int(11) DEFAULT NULL,
  `gerenteResponsavel` varchar(45) DEFAULT NULL,
...
INSERT INTO `agencias` (`idAgencia`, `numeroDaConta`, `nomeAgencia`, `gerenteResponsavel`, `cnpj`, `endereco`, `cidade`, `estado`) VALUES
(1, NULL, 0, 'Bruno Santos', 12345678910, 'rua 1 numero 6', 'aaaa', 'SC'),
(2, NULL, 0, 'Messi Silva', 12345678911, 'rua 2 numero 5', 'aaab', 'SP'),
(3, NULL, 0, 'Bruno Campos', 12345678912, 'rua 3 numero 4', 'aaac', 'SC'),
(4, NULL, 0, 'Amanda Silveira', 12345678913, 'rua 4 numero 3', 'aaad', 'RS'),
(5, NULL, 0, 'Bruno Costa', 12345678914, 'rua 5 numero 2', 'aaae', 'RJ'),
(6, NULL, 0, 'Carlos Meira', 12345678915, 'rua 6 numero 1', 'aaaf', 'MA'),
(7, NULL, 0, 'Arthur Maximus', 12345678916, 'rua 7 numero 10', 'aaag', 'DF');

-- --------------------------------------------------------

--
-- Estrutura da tabela `appjpbank`
--

CREATE TABLE `appjpbank` (
  `id` int(11) NOT NULL,
  `numeroConta` int(11) DEFAULT NULL,
  `nomeUsuario` varchar(45) DEFAULT NULL,
  `saldoDisponivel` float DEFAULT NULL,
  `transacoes` text DEFAULT NULL,
  `extrato` text DEFAULT NULL,
  `dinheiroRecebido` float DEFAULT NULL,
  `comprovanteTransacoes` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Extraindo dados da tabela `appjpbank`
--

INSERT INTO `appjpbank` (`id`, `numeroConta`, `nomeUsuario`, `saldoDisponivel`, `transacoes`, `extrato`, `dinheiroRecebido`, `comprovanteTransacoes`) VALUES
(1, NULL, 'Marcos Lombra', 100, 'compra mercado 10.00', '2025-12-12 deposito 10.00 saldo 100', 0, 'pagamento via pix, valor 10.00'),
(2, NULL, 'Marcio Junior', 107, 'compra mercado 10.01', '2025-11-11 deposito 10.00 saldo 100', 10, 'pagamento via credito, valor 10.01'),
(3, NULL, 'Mauricio Silva', 106, 'compra mercado 10.02', '2025-10-12 deposito 10.00 saldo 100', 20, 'pagamento via pix, valor 10.02'),
(4, NULL, 'Matheus Costa', 105, 'compra mercado 10.03', '2025-09-12 deposito 10.00 saldo 100', 30, 'pagamento via débito, valor 10.03'),
(5, NULL, 'Mateus Oliveira', 104, 'compra mercado 10.04', '2025-08-09 deposito 10.00 saldo 100', 40, 'pagamento via pix, valor 10.04'),
(6, NULL, 'Natan Mendes', 103, 'compra mercado 10.05', '2025-07-05 deposito 10.00 saldo 100', 50, 'pagamento via débito, valor 10.05'),
(7, NULL, 'Antonio Junior', 102, 'compra mercado 10.06', '2025-06-10 deposito 10.00 saldo 100', 60, 'pagamento via crédito, valor 10.06'),
(8, NULL, 'Iago Mosquetes', 101, 'compra mercado 10.07', '2025-05-12 deposito 10.00 saldo 100', 70, 'pagamento via pix, valor 10.07');
...
INSERT INTO `cartao` (`numeroCartao`, `nome`, `tipo`, `codigoSeguranca`, `dataVencimento`, `bandeira`, `cor`) VALUES
(1, 'Marcos A', 'Crédito', 123, '25/12', 'Elo', 'Branco'),
(2, 'Marcos B', 'Débito', 124, '25/11', 'Mastercard', 'Preto'),
(3, 'Marcos C', 'Crédito', 125, '25/10', 'visa', 'Branco'),
(4, 'Marcos D', 'Débito', 126, '25/09', 'Mastercard', 'Branco'),
(5, 'Marcos E', 'Crédito', 127, '25/08', 'Elo', 'Cinza'),
(6, 'Marcos F', 'Débito', 128, '25/07', 'Mastercard', 'Preto'),
(7, 'Marcos G', 'Crédito', 129, '25/06', 'visa', 'Amarelo');
...
CREATE TABLE `conta` (
  ...
  `agencia` bigint(6) DEFAULT NULL,
  `conta` bigint(6) DEFAULT NULL,
...
INSERT INTO `conta` (`numeroConta`, `nome`, `tipoConta`, `agencia`, `conta`, `dataCriacao`, `empresa`, `idCliente`) VALUES
(1, 'Rogerio Silva', 'corrente', 11111, 111111, '0000-00-00', 'Rooxo', NULL),
(2, 'Roberto Santos', 'poupança', 11112, 111112, '0000-00-00', 'Tagcat', NULL),
(3, 'Marcio Silverira', 'poupança', 11113, 111113, '0000-00-00', 'Rooxo', NULL),
(4, 'Mauricio Campos', 'corrente', 11114, 111114, '0000-00-00', 'Vidoo', NULL),
(5, 'Iago Costa', 'poupança', 11115, 111115, '0000-00-00', 'Bluejam', NULL),
(6, 'Fabricio Maravilha', 'digital', 11116, 111116, '0000-00-00', 'Rooxo', NULL),
(7, 'Tiago Silva', 'corrente', 11117, 111117, '0000-00-00', 'Fiveclub', NULL);
...
CREATE TABLE `funcionarios` (
  ...
  `cargaHoraria` smallint(2) DEFAULT NULL,
...
INSERT INTO `funcionarios` (`numeroCracha`, `nome`, `salario`, `funcao`, `turno`, `cargaHoraria`, `cpf`) VALUES
(1, 'Iago A', 2, 'Admnistrativo', 'matutino', 10, 2345678910),
(2, 'Iago B', 2.001, 'Atendimento', 'Vespertino', 11, 12345678910),
(3, 'Iago C', 2.002, 'Admnistrativo', 'matutino', 12, 22345678910),
(4, 'Iago D', 2.003, 'Atendimento', 'Vespertino', 9, 32345678910),
(5, 'Iago E', 2.004, 'Admnistrativo', 'matutino', 8, 42345678910),
(6, 'Iago F', 2.005, 'Atendimento', 'Vespertino', 9, 52345678910),
(7, 'Iago G', 2.006, 'Admnistrativo', 'matutino', 10, 62345678910);
...
CREATE TABLE `setores` (
  ...
  `numeroCrachaFuncionario` int(11) DEFAULT NULL,
  `nomeSetor` varchar(45) DEFAULT NULL,
  `responsavel` varchar(45) DEFAULT NULL,
  `fone` bigint(11) DEFAULT NULL,
  `emailSetor` varchar(100) DEFAULT NULL,
  `quantidadeDeFuncionarios` int(11) DEFAULT NULL,
  `numeroFuncionariosAtivos` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `setores` (`idSetor`, `numeroCrachaFuncionario`, `nomeSetor`, `responsavel`, `fone`, `emailSetor`, `quantidadeDeFuncionarios`, `numeroFuncionariosAtivos`) VALUES
(1, NULL, 'Admnistrativo', 'Sergio A', 49900000001, 'setor1@gmail.com', 20, 10),
(2, NULL, 'Atendimento', 'Sergio B', 49900000002, 'setor2@gmail.com', 21, 11),
(3, NULL, 'Admnistrativo', 'Sergio C', 49900000003, 'setor3@gmail.com', 22, 12),
(4, NULL, 'Suporte', 'Sergio D', 49900000004, 'setor4@gmail.com', 23, 13),
(5, NULL, 'Admnistrativo', 'Sergio E', 49900000005, 'setor5@gmail.com', 24, 14),
(6, NULL, 'Suporte', 'Sergio F', 49900000006, 'setor6@gmail.com', 25, 15),
(7, NULL, 'Atendimento', 'Sergio G', 49900000007, 'setor7@gmail.com', 26, 16);
...
ALTER TABLE `admnistrativo`
  ADD PRIMARY KEY (`documentoResponsavel`);
...
--
-- Índices para tabela `appjpbank`
--
ALTER TABLE `appjpbank`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `setores`
  ...
  ADD KEY `numeroCrachaFuncionario` (`numeroCrachaFuncionario`);
...
--
ALTER TABLE `agencias`
  MODIFY `idAgencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de tabela `appjpbank`
--
ALTER TABLE `appjpbank`
...
--
ALTER TABLE `funcionarios`
  MODIFY `numeroCracha` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `setores`
  MODIFY `idSetor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- Limitadores para a tabela `appjpbank`
--
ALTER TABLE `appjpbank`
  ADD CONSTRAINT `appjpbank_ibfk_1` FOREIGN KEY (`numeroConta`) REFERENCES `conta` (`numeroConta`);
...
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`numeroDoCartao`) REFERENCES `cartao` (`numeroCartao`),
  ADD CONSTRAINT `pedido_ibfk_2` FOREIGN KEY (`idDoCliente`) REFERENCES `clientes` (`idCliente`);

--
-- Limitadores para a tabela `setores`
--
ALTER TABLE `setores`
  ADD CONSTRAINT `setores_ibfk_1` FOREIGN KEY (`numeroCrachaFuncionario`) REFERENCES `funcionarios` (`numeroCracha`);
COMMIT;
